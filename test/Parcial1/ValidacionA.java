...
public class ValidacionA
{
    ...
    public ValidacionA(String palabra, String expected) {
    ...
    public static Collection palabrasPrueba()
    {
        ...
        for (Integer i = 0; i < 100; i++) {
            ...
            lista[i][1] = clase.cifrar(palabras[i], 3);
        }
    ...
    public void tstCifrado()
    {
        ...
        assertEquals("error en la palabra " + palabra, expected, clase.cifrar(palabra, 3));
    }
